...
/**
  qapi_FS_Iter_Open exposure to user space makes the system vulnerable to
...
/**
  qapi_FS_Iter_Next exposure to user space makes the system vulnerable to
  security attacks. So the support is deprecated.
*/                                                                                                                                                                                                                                                                                                                
...
/**
  qapi_FS_Iter_Close exposure to user space makes the system vulnerable to
  security attacks. So the support is deprecated.
*/                   
 ...
 *
 * @note1hang Support for this QAPI is deprecated.
 */
