...
/** 
    ...
    @param[in] hndl Handle received from qapi_DSS_Get_Data_Srvc_Hndl().
    @param[out] mtu Buffer containing the MTU information. For IPv4v6 call, if IPv4 and IPv6 got different MTU Size, the smaller one will returned.
...
/**  
    @versiontable{2.0,2.45,
    Data\_Services 1.4.0  &  Introduced. @tblendline
    }
    @ingroup qapi_DSS_Get_Apn_Rate_Control

    Gets apn rate control info

    @param[in] hndl Handle received from qapi_DSS_Get_Data_Srvc_Hndl().
    @param[out] apn_rate_control apn rate control info
...
/**  
    ...
    @ingroup qapi_DSS_Get_Splmn_Rate_Control

    Gets splmn rate control info

    @param[in] hndl Handle received from qapi_DSS_Get_Data_Srvc_Hndl().
    @param[out] splmn_rate_control splmn rate control info
