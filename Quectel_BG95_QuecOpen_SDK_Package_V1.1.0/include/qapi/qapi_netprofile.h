...
/**
*  Structure to hold netbuf pool entity. Each netbuf entry is  number of buffer and size.
*/
typedef struct {
   int32_t buf_Num;
...
/**
* QAPI to set customized netbuf pool.
*
...
/**
*  Set active profile. Profile can from the predefined netbuf profiles.
*
