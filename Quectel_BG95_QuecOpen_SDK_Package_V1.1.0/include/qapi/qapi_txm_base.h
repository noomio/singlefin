...
#define CUSTOM_CB_QAPI_QUECTEL_API_BASE           (CUSTOM_CB_QAPI_LOCATION_EXT_BASE + CUSTOM_CB_QAPI_LOCATION_EXT_NUM_IDS)
#define CUSTOM_CB_QAPI_QUECTEL_API_NUM_IDS        10
