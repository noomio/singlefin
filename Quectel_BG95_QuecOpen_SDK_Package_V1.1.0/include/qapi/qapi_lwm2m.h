...
typedef enum qapi_Net_LWM2M_Object_ID_e 
{
  ...
  QAPI_NET_LWM2M_CELL_NW_CONN_OBJECT_ID_E    =  10,  /**< Celluar Network connectivity obj. */
...
/**
 * Enum used to identify a particular resource of a security object.
*/  
...
/**
 * Enum used to identify a particular resource of a server object.
*/  
...
/** Enum to identify valid nw connectivity resource IDs.
*/
...
/** Enum to identify valid apn profile connection resource IDs.
*/
...
typedef enum qapi_Net_LWM2M_Config_Type_t
{
  ...
  QAPI_NET_LWM2M_CONFIG_BOOTSTRAP_INFO  = 3,  /**< config the bootstrap info with value.lwm2m_data filled in qapi_Net_LWM2M_Config_Data_t. */
...
/**
*   Registers an application with an LWM2M client. The application gets a handle  
