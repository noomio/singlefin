...
set APP_OUTPUT_PATH=quectel\build
...
set APP_SRC_PATH=quectel\example\%1%\src
set APP_INC_PATH=quectel\example\%1%\inc
...
%TOOLCHAIN_PATH%\armcc -E -g %DAM_CPPFLAGS% %DAM_CFLAGS% %APP_SRC_P_PATH%\example\txm_module_preamble.S > txm_module_preamble_pp.S
