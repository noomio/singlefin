...
set DAM_COMMON_SRC_PATH=..\data_common\non_data_call
...
set DAM_ELF_NAME=helloworld_dam_demo.elf
set DAM_TARGET_BIN=helloworld_dam_demo.bin
set DAM_MAP_NAME=helloworld_dam_demo.map
...
set DAM_APP_INCPATHS=-I %DAM_COMMON_SRC_PATH% -I %DAM_UTILS_SRC_PATH% -I %DEMO_APP_SRC_PATH% %DAM_INCPATHS%
...
%TOOLCHAIN_PATH%\clang.exe -c %DAM_CPPFLAGS% %DAM_CFLAGS% %DAM_APP_INCPATHS% %DAM_COMMON_SRC_PATH%\*.c
