...
export DAM_COMMON_SRC_PATH="../data_common/non_data_call"
...
export DAM_ELF_NAME="helloworld_dam_demo.elf"
export DAM_TARGET_BIN="helloworld_dam_demo.bin"
export DAM_MAP_NAME="helloworld_dam_demo.map"
...
export DAM_APP_INCPATHS="-I $DAM_COMMON_SRC_PATH -I $DAM_UTILS_SRC_PATH -I $DEMO_APP_SRC_PATH $DAM_INCPATHS"
...
$TOOLCHAIN_PATH/clang -c $DAM_CPPFLAGS $DAM_CFLAGS  $DAM_APP_INCPATHS $DAM_COMMON_SRC_PATH/*.c 
