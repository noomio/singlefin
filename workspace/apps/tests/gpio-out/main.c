...
int main(int argc, char * argv[])
{
	...
	int res = gpio_pin_config(19,QAPI_GPIO_12MA_E,QAPI_GPIO_NO_PULL_E,QAPI_GPIO_OUTPUT_E);
	printf("res=%d\r\n",res);
	gpio_pin_config(26,QAPI_GPIO_12MA_E,QAPI_GPIO_NO_PULL_E,QAPI_GPIO_OUTPUT_E);

	for(;;){

		gpio_pin_write(18,true);
		res = gpio_pin_write(19,true);
		printf("res=%d\r\n",res);
