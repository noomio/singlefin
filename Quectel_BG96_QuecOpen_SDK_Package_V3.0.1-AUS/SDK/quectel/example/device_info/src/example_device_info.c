...
*/
void qt_qapi_callback(qapi_Device_Info_Hndl_t device_info_hndl, const qapi_Device_Info_t *dev_info)
{
	...
	switch(dev_info->info_type)
	{
		...
		case QAPI_DEVICE_INFO_TYPE_INTEGER_E:
			qt_uart_dbg(uart_conf.hdlr, "~[i][%d][%lld]", dev_info->id, dev_info->u.valueint);
		break;
