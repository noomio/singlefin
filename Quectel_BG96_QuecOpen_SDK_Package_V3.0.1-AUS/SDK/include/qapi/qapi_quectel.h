...
typedef enum
{
	...
	TXM_OEM_API_QT_REL_INFO = TXM_OEM_API_QT_BASE+1,
	TXM_OEM_API_QT_RESET_DEVICE = TXM_OEM_API_QT_BASE+2,

	/** ATC PIPE TXM ID */
	TXM_OEM_API_AT_PORT_OPEN = TXM_OEM_API_QT_BASE+3,
	TXM_OEM_API_AT_SEND = TXM_OEM_API_QT_BASE+4,
	TXM_OEM_API_AT_SEND_HEXBYTE = TXM_OEM_API_QT_BASE+5,
	TXM_OEM_API_AT_SEND_GENERAL = TXM_OEM_API_QT_BASE+6,
	TXM_OEM_API_AT_PORT_CLOSE = TXM_OEM_API_QT_BASE+7,

	/** ADC TXM ID */
	TXM_OEM_API_QT_ADC_READ = TXM_OEM_API_QT_BASE+8,

	/** GNSS TXM ID */
	TXM_OEM_API_QT_LOC_START = TXM_OEM_API_QT_BASE+9,
	TXM_OEM_API_QT_LOC_STOP = TXM_OEM_API_QT_BASE+10,

    /** FOTA TXM ID */
    TXM_OEM_API_QT_FOTA_REMOVE_PACKAGE = TXM_OEM_API_QT_BASE+11,
    TXM_OEM_API_QT_FOTA_HTTP_DL_START = TXM_OEM_API_QT_BASE+12,
    TXM_OEM_API_QT_FOTA_UPDATE_START = TXM_OEM_API_QT_BASE+13,

	/** RAI TXM ID*/
	TXM_OEM_API_QT_RAI = TXM_OEM_API_QT_BASE+14,

	TXM_OEM_API_QT_SAHARA_GET = TXM_OEM_API_QT_BASE+15,
	TXM_OEM_API_QT_SAHARA_SET = TXM_OEM_API_QT_BASE+16,

	/** PSM CORE CONFIG TXM ID*/
	TXM_OEM_API_QT_PSM_SRV_CFG_SET = TXM_OEM_API_QT_BASE+17,
	TXM_OEM_API_QT_PSM_SRV_CFG_GET = TXM_OEM_API_QT_BASE+18,

	/** SHUTDOWN TXM ID*/
	TXM_OEM_API_QT_SHUTDOWN_DEVICE = TXM_OEM_API_QT_BASE+19,

	TXM_OEM_API_QT_REG_WDOG = TXM_OEM_API_QT_BASE+20,
	TXM_OEM_API_QT_KICK_WDOG = TXM_OEM_API_QT_BASE+21,
	TXM_OEM_API_QT_STOP_WDOG = TXM_OEM_API_QT_BASE+22,
	TXM_OEM_API_QT_USBMODE_SET = TXM_OEM_API_QT_BASE+23,

	/* USB EVENT */
	TXM_OEM_API_QT_GET_USB_EVENT = TXM_OEM_API_QT_BASE+24,
	TXM_OEM_API_QT_PWRKEY_EVENT_SET = TXM_OEM_API_QT_BASE+25,
	TXM_OEM_API_QT_PWRKEY_EVENT_GET = TXM_OEM_API_QT_BASE+26,

	/* GET RANDOM DATE */
	TXM_OEM_API_QT_PRNG_DATA_GET = TXM_OEM_API_QT_BASE+27,

    /** FOTA EXTENDED TXM ID */
    TXM_OEM_API_QT_FOTA_GET_PACKAGE_INFO = TXM_OEM_API_QT_BASE+28,
    TXM_OEM_API_QT_FOTA_HTTP_DL_CANCEL = TXM_OEM_API_QT_BASE+29,

	TXM_OEM_API_QT_USB_SWITCH_SET = TXM_OEM_API_QT_BASE+30,
	TXM_OEM_API_QT_USB_SWITCH_GET = TXM_OEM_API_QT_BASE+31,
	TXM_OEM_API_QT_CHIP_SERIAL_NUM_GET = TXM_OEM_API_QT_BASE+32,
...
#define FOTA_DL_RESP_CB                CUSTOM_CB_QAPI_QUECTEL_API_BASE + 5
#define FOTA_UPGRADE_RESP_CB           CUSTOM_CB_QAPI_QUECTEL_API_BASE + 6
#define FOTA_UPGRADE_PRO_CB            CUSTOM_CB_QAPI_QUECTEL_API_BASE + 7
...
static __inline void  qapi_fota_upgrade_resp_cb_uspace_dispatcher(UINT cb_id,
                                                             void *app_cb,
                                                             UINT cb_param1,
                                                             UINT cb_param2,
                                                             UINT cb_param3,
                                                             ...
                                                             UINT cb_param8)
{
	void (*pfn_app_cb1)(short int);
	if(cb_id == FOTA_UPGRADE_RESP_CB)
	{
		pfn_app_cb1 = (void (*)(short int))app_cb;
   		(pfn_app_cb1)((short int)cb_param1);
	}
}

static __inline void  qapi_fota_upgrade_pro_cb_uspace_dispatcher(UINT cb_id,
                                                             void *app_cb,
                                                             UINT cb_param1,
                                                             UINT cb_param2,
                                                             UINT cb_param3,
                                                             ...
                                                             UINT cb_param8)
{
	void (*pfn_app_cb1)(uint8, uint8);
	if(cb_id == FOTA_UPGRADE_PRO_CB)
	{
		pfn_app_cb1 = (void (*)(uint8, uint8))app_cb;
   		(pfn_app_cb1)((uint8)cb_param1, (uint8)cb_param2);
	}
}
...
#define qapi_QT_Fota_Http_Download_Start(a,b)      ((UINT)(_txm_module_system_call4)(TXM_OEM_API_QT_FOTA_HTTP_DL_START,(ULONG)a, (ULONG)b, (ULONG)0, (ULONG)qapi_fota_dl_start_cb_uspace_dispatcher))
#define qapi_QT_Fota_Update_Start(a,b)		       ((UINT)(_txm_module_system_call5)(TXM_OEM_API_QT_FOTA_UPDATE_START,(ULONG)a, (ULONG)b, (ULONG)0, (ULONG)qapi_fota_upgrade_resp_cb_uspace_dispatcher, (ULONG)qapi_fota_upgrade_pro_cb_uspace_dispatcher))
...
#define qapi_QT_USB_Mode_Set(a)					((UINT)(_txm_module_kernel_call_dispatcher)(TXM_OEM_API_QT_USBMODE_SET,(ULONG)a, (ULONG)0, (ULONG)0))
...
#define qapi_QT_Chip_Serial_Num_Get(a)							((UINT)(_txm_module_kernel_call_dispatcher)(TXM_OEM_API_QT_CHIP_SERIAL_NUM_GET,(ULONG)a, (ULONG)0,(ULONG)0))
#else
...
@param [in]
  Enable or disable configuration of USB functions by the AT command
