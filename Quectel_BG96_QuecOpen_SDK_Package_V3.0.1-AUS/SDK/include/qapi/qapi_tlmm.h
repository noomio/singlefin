...
*          should cache the ID. 
*/
typedef uint32_t qapi_GPIO_ID_t; // Egbert fix for Data type mismatch
...
#ifdef QUECTEL_QUECOPEN_QT_API_SUPPORT
/* ============================================================================
*  Function : qapi_QT_TLMM_Read_Gpio
* ============================================================================*/
/**
  @brief Reads the state of an SoC pin configured as an input GPIO.
  ...
  QAPI_ERR -- Operation failed.
*/
qapi_Status_t qapi_QT_TLMM_Read_Gpio(
  qapi_GPIO_ID_t qapi_GPIO_ID,
  uint32_t       pin,
  qapi_GPIO_Value_t* qapi_GPIO_Value
);
